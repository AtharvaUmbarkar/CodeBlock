...
const NavBar: React.FC<NavProps> = ({ toggleScroll }) => {
  ...
  return (
    <div className='sticky top-0 backdrop-blur-md w-full lg:w-max flex flex-row lg:flex-col'>
      <header className=' w-full flex flex-row items-center border-b border-solid border-blue-700 py-1.5 md:pb-2 lg:border-r lg:border-solid lg:border-blue-700'>
        ...
        <nav className={(navOpen ? 'block' : 'hidden') + ' lg:block w-full absolute h-navbar bg-blue-50 top-full flex-col text-base lg:text-lg list-none lg:border-r lg:border-solid lg:border-blue-700'}>
          <ul className='w-1/2 lg:w-full h-full flex flex-col bg-blue-100 p-1 divide-y-2 divide-blue-900 divide-opacity-20 overflow-y-auto'>
            <li className='pt-0'>
              <div className='flex flex-row items-center cursor-pointer p-1 m-1 my-2 rounded-sm'>
