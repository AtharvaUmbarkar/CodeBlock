...
const CodeBlock = () => {
  ...
  } = useSWRImmutable('fetch-themes', fetchThemes);

  const {
    data: languages,
    error: languageError,
    isLoading: languagesLoading
  } = useSWRImmutable('fetch-languages', fetchLanguages);
    ...
    <div id='code-block' className='flex flex-col items-center flex-grow lg:min-h-screen w-full bg-white relative'>
      <div className='flex flex-col items-center w-[95%]'>
        ...
        <div className='self-start flex flex-row items-center mt-6 mb-2 w-full'>
          <div onClick={() => setOpenModal(true)} className='text-blue-500 bg-white text-3xl h-auto aspect-square border-2 border-solid border-blue-500 p-0 flex flex-row items-center justify-center rounded-md cursor-pointer'>
            <MdEdit className='text-2xl m-0.5' />
          </div>
          <div className='self-start font-medium flex-grow text-3xl text-ellipsis bg-white px-3'>
            {codeDetails.title}
          </div>
        </div>
        ...
        >
          <div className='flex flex-col'>
            <div className='text-2xl self-center'>Edit Details</div>
            <div className='flex flex-col gap-x-2 my-2'>
              <label htmlFor="code-title" className='text-lg font-semibold text-blue-700 cursor-pointer'>Title*</label>
              <input
                id='code-title'
                name='code-title'
                type="text"
                ...
                className='p-2 outline-none border-2 border-solid border-blue-300 focus:border-blue-600 rounded-sm text-lg'
              />
            </div>
            <div className='flex flex-col gap-x-2 my-2'>
              <label htmlFor="code-source" className='text-lg font-semibold text-blue-700 cursor-pointer'>Source</label>
              <input
                id='code-source'
                name='code-source'
                type="text"
            ...
            <div className='flex flex-col gap-x-2 my-2'>
              <label htmlFor="code-description" className='text-lg font-semibold text-blue-700 cursor-pointer'>Description</label>
              <textarea
                id='code-description'
                name='code-description'
                onChange={(e) => handleModalDetailsChange(e)}
                value={modalDetails['code-description']}
                className='max-h-72 min-h-[6rem] p-2 outline-none border-2 border-solid border-blue-300 focus:border-blue-600 rounded-sm text-lg'
              />
            </div>
            <div className='flex flex-row gap-2 my-3 justify-center'>
              <button type='button' onClick={handleEditDetailsDone} className='py-1.5 px-4 bg-blue-600 text-white font-medium hover:bg-blue-500 rounded-sm'>Done</button>
              <button type='button' onClick={handleEditDetailsCancel} className='py-1.5 px-4 bg-blue-600 text-white font-medium hover:bg-blue-500 rounded-sm'>Cancel</button>
            </div>
          </div>
        </ReactModal>

        <div className=' w-full text-base md:text-lg text-black mb-4 bg-blue-100 py-1 px-2 flex flex-col items-center'>
          <div className='flex flex-col xl:flex-row items-start xl:items-center gap-x-4 w-full max-w-sm lg:max-w-md xl:max-w-none'>
            ...
            <Listbox as={'div'} className={'flex flex-row items-center justify-between xl:justify-start w-full xl:w-auto my-1'}>
              ...
              <div className='flex flex-col relative w-max'>
                <Listbox.Button className={'bg-white border-2 flex flex-row items-center justify-between text-center pl-4 font-medium border-solid border-blue-400 hover:border-blue-600 px-1 py-1 rounded-md w-40 md:w-44'}>
                  ...
                  <Listbox.Options tabIndex={0} className='absolute top-full z-10 bg-white mt-1 cursor-pointer w-40 md:w-44 text-center overflow-y-scroll h-96'>
                    {Object.keys(languages).map((l: string) => (
                      <Listbox.Option
                        key={l}
                        value={languages[l]}
                        className={(codeDetails.language == l ? 'bg-blue-700 text-white' : 'hover:bg-blue-400') + ' py-1.5 px-1'}
            ...
            <Listbox as={'div'} className={'flex flex-row items-center justify-between xl:justify-start w-full xl:w-auto my-1'}>
              ...
              <div className='flex flex-col relative w-max'>
                <Listbox.Button className={'bg-white border-2 flex flex-row items-center justify-between text-center pl-4 font-medium border-solid border-blue-400 hover:border-blue-600 px-1 py-1 rounded-md w-64 md:w-72'}>
                  ...
                  <Listbox.Options tabIndex={0} className='absolute top-full z-10 bg-white mt-1 cursor-pointer w-64 md:w-72 text-center overflow-y-scroll h-96'>
                    {Object.keys(themes).map((t: string) => (
                      <Listbox.Option
                        key={t}
                        value={themes[t].name}
                        className={(codeDetails.theme == t ? 'bg-blue-700 text-white' : 'hover:bg-blue-400') + ' py-1.5 px-1'}
            ...
            <Listbox as={'div'} className={'flex flex-row items-center justify-between xl:justify-start w-full xl:w-auto my-1'}>
              ...
              <div className='flex flex-col relative w-max'>
                <Listbox.Button className={'bg-white border-2 flex flex-row items-center justify-between text-center pl-4 font-medium border-solid border-blue-400 hover:border-blue-600 px-1 py-1 rounded-md w-16'}>
                  ...
                  <Listbox.Options tabIndex={0} className='absolute top-full z-10 bg-white mt-1 cursor-pointer w-16 text-center overflow-y-scroll h-96'>
                    {fonts.map((f: number) => (
                      <Listbox.Option
                        key={f}
                        value={f}
                        className={(codeDetails.editorOptions.fontSize == f ? 'bg-blue-700 text-white' : 'hover:bg-blue-400') + ' py-1.5 px-1'}
        ...
        <div className='w-full flex flex-col md:flex-row text-lg my-4 items-start'>
          <Switch.Group as={'div'} className={'w-fit grid text-lg self-center md:self-auto md:items:center'}>
            <div className="flex flex-row justify-between w-64 items-center">
              ...
              <Switch
                ...
                className={`${codeDetails.editorOptions.readOnly ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
              >
                <span
            ...
            <div className="flex flex-row justify-between w-64 items-center">
              ...
              <Switch
                ...
                className={`${codeDetails.editorOptions.autoIndent === 'advanced' ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
              >
                <span
            ...
            <div className="flex flex-row justify-between w-64 items-center">
              ...
              <Switch
                ...
                className={`${codeDetails.editorOptions.cursorStyle === 'block' ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
              >
                <span
            ...
            <div className="flex flex-row justify-between w-64 items-center">
              ...
              <Switch
                ...
                className={`${codeDetails.editorOptions.mouseWheelZoom ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
              >
                <span
            ...
            <div className="flex flex-row justify-between w-64 items-center">
              ...
              <Switch
                ...
                className={`${codeDetails.editorOptions.wordWrap === 'on' ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
              >
                <span
            ...
            <div className="flex flex-row justify-between w-64 items-center">
              ...
              <Switch
                ...
                className={`${codeDetails.editorOptions.minimap?.enabled ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
              >
                <span
          ...
          <div className='flex flex-row flex-grow gap-2 self-center md:self-auto md:items-center justify-end my-8 md:my-0'>
            <div className='px-2 py-2 w-24 cursor-pointer flex flex-row items-center justify-center bg-blue-600 hover:bg-blue-500 text-white text-base md:text-lg rounded-sm'>Save</div>
            <div className='px-2 py-2 w-28 cursor-pointer flex flex-row items-center justify-center bg-blue-600 hover:bg-blue-500 text-white text-base md:text-lg rounded-sm'>Finish <MdArrowForwardIos className='ml-2' /></div>
          </div>
